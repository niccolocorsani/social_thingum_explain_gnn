...
from montecarlo_with_diff import MonteCarloWithDiff, get_index_starting_from_nodes
...
#### Da rimuovere assolutamente in produzione
  ...
  for i in range(60):
    ...
    monte_carlo = MonteCarloWithDiff(heterodata=data, edge_index=edge_index, deepnes_of_node_expansion=int(deepnes),
